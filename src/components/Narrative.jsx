          ...
          {phases.map((phase, i) => {
            ...
            return (
              <Reveal key={phase.id} delay={i * 0.1}>
                <article className="surface glow-wine-hover relative flex h-full flex-col gap-5 rounded-2xl p-7 sm:p-8">
                  <div className="flex items-center justify-between gap-3">
                    <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-crimson/10 text-crimson-soft">
                  ...
                  <div className="flex flex-col gap-2">
                    <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-crimson-soft">
                      {text.label}
                    </span>
                  ...
                  {i < phases.length - 1 && (
                    <span
                      className="absolute -end-3 top-1/2 hidden h-px w-6 bg-gradient-to-r from-crimson/45 to-transparent lg:block"
                      aria-hidden="true"
                    />
                  )}
                </article>
